...
Protected Class TableLayout
	#tag Method, Flags = &h0
		Sub ApplyLayout()
		  ...
		  Var rowH As Double = availH / rowCount
		  ...
		  For r As Integer = 0 To rowCount-1
		    ...
		    For Each cell As LayoutCell In lr.Cells
		      ...
		      Var y As Double = Padding + r*(rowH+Gap)
		      Var w As Double = (colW*cs) + (Gap*(cs-1))
		      Var h As Double = (rowH*rs) + (Gap*(rs-1))
	...
	#tag Property, Flags = &h0
		Owner As DesktopWindow
	#tag EndProperty

	#tag Property, Flags = &h0
		Padding As Integer = 8
	#tag EndProperty
